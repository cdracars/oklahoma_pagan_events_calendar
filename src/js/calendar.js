...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function initCalendar() {
    ...
    fetchEvents().then(data => {
      let events = data;
      updateCalendarDisplay(); // Update the calendar display after fetching events
    });
    ...
    function updateCalendarDisplay(action = null) {
      ...
      const filteredEvents = events.filter(event => !selectedCalendarType || event.raw.calendar === selectedCalendarType);
      calendar.clear();
